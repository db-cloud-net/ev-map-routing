...
| **Slice 4 — progressive ~60s first screen** | **Phases 1–2 shipped:** `POST /route-preview` + map preview line/TBT — [V2_API.md](./V2_API.md) § Slice 4; **Phase 3** refinements loop / §5 gating — [designs/slice4-progressive-first-screen.md](designs/slice4-progressive-first-screen.md) |
